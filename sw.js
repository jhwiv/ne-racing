...
const CACHE_VERSION = '20260606-v2.48.7-brisnet'; // v2.48.7: RESULT PENDING badge for past-post races without chart data; match NE_APP_VERSION exactly so SW_ACTIVATED compare never triggers spurious first-install reload               // bump on every ship
