...
const CACHE_VERSION = '20260606-v2.48.6-brisnet'; // P0-5 (v2.48.6): match NE_APP_VERSION exactly so SW_ACTIVATED compare never triggers spurious first-install reload               // bump on every ship
